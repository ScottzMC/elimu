    <!-- Footer Start  -->
        <div class="section footer-section">
            ...
            <div style="padding-top: 5px; padding-bottom: 10px;" class="footer-widget-section">
                        ...
                        <div class="col-lg-3 col-md-6 order-md-1 order-lg-1">
                            ...
                            <div class="footer-widget">
                                <div class="widget-logo">
                                    <a href="#"><img height="120" width="220" src="<?php echo base_url('assets/images/elimu.png'); ?>" alt="Logo"></a>
                                </div>
