...
<div id="left-sidebar" class="sidebar">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu-platform">Platform</a></li>
    </ul>
    <div class="tab-content mt-3">
        <div class="tab-pane fade show active" id="menu-admin" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li><a href="<?php echo site_url('admin/event'); ?>"><i class="fa fa-book"></i><span>Events</span></a></li>
                    ...
                    <li><a href="<?php echo site_url('admin/career_interest'); ?>"><i class="fa fa-book"></i><span>Career Interest</span></a></li>
                    <li><a href="<?php echo site_url('admin/member'); ?>"><i class="fa fa-users"></i><span>Members</span></a></li>
                    <li><a href="<?php echo site_url('admin/team'); ?>"><i class="fa fa-users"></i><span>Team</span></a></li>
                    <li><a href="<?php echo site_url('admin/testimonial'); ?>"><i class="fa fa-users"></i><span>Testimonial</span></a></li>
        ...
        <div class="tab-pane fade show" id="menu-platform" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li><a href="<?php echo site_url('admin/home'); ?>"><i class="fa fa-book"></i><span>Home</span></a></li>
                    <li><a href="<?php echo site_url('admin/about'); ?>"><i class="fa fa-book"></i><span>About Us</span></a></li>
                    <li><a href="<?php echo site_url('admin/covid'); ?>"><i class="fa fa-book"></i><span>Covid 19</span></a></li>
                    <li><a href="<?php echo site_url('admin/elimu_pillar'); ?>"><i class="fa fa-book"></i><span>Elimu Pillars</span></a></li>
                    <li><a href="<?php echo site_url('admin/opportunity'); ?>"><i class="fa fa-book"></i><span>Opportunity</span></a></li>
                    <li><a href="<?php echo site_url('admin/skill_centre'); ?>"><i class="fa fa-book"></i><span>Skill Centre</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
