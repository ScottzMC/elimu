                    ...
                    <div class="header-main-wrapper">
                        ...
                        <div class="header-sign-in-up d-none d-lg-block">
                            ...
                            <?php }else if($this->session->userdata('urole') == 'Admin'){ ?>
                                ...
                                <li><a style="color: #dda20b;" class="sign-in" href="<?php echo site_url('logout'); ?>">Logout </a></li>
                            <?php }else{ ?>
                                <li><a style="color: #dda20b;" class="sign-in" href="<?php echo site_url('login'); ?>">Login </a></li>
                                <li><a style="color: #dda20b;" class="sign-up" href="<?php echo site_url('register'); ?>">Register </a></li>
                            <?php } ?>
                            </ul>
                        </div>
