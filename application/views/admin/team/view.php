                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Team-all">
                        ...
                        function delete_team(id){
                          ...
                          $.post('<?php echo base_url('admin/delete_team'); ?>', {"del_id": del_id}, function(data){
                                ...
                                <tbody>
                                  <?php if($team){ foreach($team as $tem){ ?>
                                    <tr>
                                        ...
                                        <td class="w60">
                                            <img class="avatar" src="https://scottnnaghor.com/elimu/uploads/team/<?php echo $tem->image; ?>" alt="<?php echo $tem->fullname; ?>">
                                        </td>
                                        <td><span class="font-16"><?php echo $tem->fullname; ?></span></td>
                                        <td><?php echo $tem->role; ?></td>
                                        <td><a href="<?php echo site_url('admin/edit_team/'.$tem->id); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Team-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/add_team'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
