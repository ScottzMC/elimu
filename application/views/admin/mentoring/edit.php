                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Mentoring-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/mentoring/edit/'.$ment->title); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                ...
                                <form action="<?php echo base_url('admin/mentoring/edit_image/'.$ment->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
