            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Shop-edit">Edit Shop</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="Shop-edit">
                        <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" value="<?php echo str_replace('-', ' ', $shp->title); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                &pound;<input type="text" name="price" class="form-control" value="<?php echo $shp->price; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea id="summernote" name="body" class="form-control" aria-label="With textarea"><?php echo $shp->body; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
