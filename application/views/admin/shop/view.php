                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Shop-all">
                        ...
                        function delete_shop(id){
                          ...
                          $.post('<?php echo base_url('admin/delete_shop'); ?>', {"del_id": del_id}, function(data){
                        ...
                        function delete_order(id){
                          ...
                          $.post('<?php echo base_url('admin/delete_order'); ?>', {"del_id": del_id}, function(data){
                            alert('Deleted Successfully');
                            location.reload();
                            $('#ctj').html(data)
                            });
                                ...
                                <tbody>
                                  <?php if($shop){ foreach($shop as $shp){ ?>
                                    <tr>
                                        ...
                                        <td class="w60">
                                            <img class="avatar" src="https://scottnnaghor.com/elimu/uploads/shop/<?php echo $shp->image; ?>" alt="">
                                        </td>
                                        ...
                                        <td><a href="<?php echo site_url('admin/edit_shop/'.$shp->id); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Shop-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/add_shop'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                ...
                                <tbody>
                                  <?php if($orders){ foreach($orders as $ord){ ?>
                                    <tr>
                                        ...
                                        <td class="w60">
                                            <img class="avatar" src="https://scottnnaghor.com/elimu/uploads/shop/<?php echo $ord->image; ?>" alt="">
                                        </td>
                                        ...
                                        <td><a href="<?php echo site_url('admin/edit_order/'.$ord->id); ?>">Edit</a></td>
