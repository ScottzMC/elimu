...
<title>Admin || Elimu</title>

<!-- Bootstrap Core and vandor -->
<link rel="stylesheet" href="<?php echo base_url('admin/assets/plugins/bootstrap/css/bootstrap.min.css'); ?>" />

<!-- Plugins css -->
<link rel="stylesheet" href="<?php echo base_url('admin/assets/plugins/summernote/dist/summernote.css'); ?>"/>
...
<!-- Start all plugin js -->
<script src="<?php echo base_url('admin/assets/bundles/counterup.bundle.js'); ?>"></script>
<script src="<?php echo base_url('admin/assets/bundles/apexcharts.bundle.js'); ?>"></script>
<script src="<?php echo base_url('admin/assets/bundles/summernote.bundle.js'); ?>"></script>

<!-- Start project main js  and page js -->
<script src="<?php echo base_url('admin/assets/js/core.js'); ?>"></script>
<script src="<?php echo base_url('admin/assets/js/page/index.js'); ?>"></script>
<script src="<?php echo base_url('admin/assets/js/page/summernote.js'); ?>"></script>
</body>
</html>
