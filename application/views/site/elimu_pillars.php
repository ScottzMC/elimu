...
<head>
    ...
    <title>Elimu Pillars || Elimu </title>
...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: #dda20b;">Elimu Pillars</li>
                    </ul>
                    <h2 class="title">Elimu <span style="color: #dda20b;">Pillars.</span></h2>
                </div>
                <!-- Page Banner End -->
            </div>
        ...
        <!-- About Start -->
        <div class="section">
            <?php if(!empty($elimu_pillar)){ foreach($elimu_pillar as $elimu){ ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('uploads/elimu_pillar/'.$elimu->image); ?>" alt="<?php echo $elimu->title; ?>">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content">
                                <h2 class="main-title"><?php echo $elimu->title; ?></h2>
                                <p><?php echo $elimu->body; ?></p>
                            </div>
                            <!-- About Content End -->
