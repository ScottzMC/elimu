            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: #dda20b;">Events</li>
                    </ul>
                    <h2 class="title">View our <span style="color: #dda20b;">Events</span></h2>
                </div>
                <!-- Page Banner End -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('uploads/event/'.$eve->image); ?>" alt="<?php echo $eve->title; ?>">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content">
                                <h2 class="main-title"><?php echo $eve->title; ?></h2>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-courses">
                                <div class="courses-images">
                                    <a href="<?php echo $poster->url; ?>"><img src="<?php echo base_url('uploads/event/'.$poster->image); ?>" alt="Events"></a>
                                </div>
                                <div class="courses-content">
                                    <h4 class="title"><a href="<?php echo $poster->url; ?>"><?php echo $poster->title; ?></a></h4>
                                </div>
                            </div>
                            <!-- Single Courses End -->
                        </div>
