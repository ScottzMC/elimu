                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('assets/images/spotlight-tier.jpg'); ?>" alt="About">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content">
                                <h2 class="main-title">Team Lead at Tier</h2>
                                <p>Tier is one of the fastest growing and most funded startups in Europe. They are actively seeking diverse talent to join their company and lead their operations team.</p>
                                <p>If you’d like to apply for this role, you can get support from Elimu and insights from a Manager at Tier.</p>
                                <p>Email hello@elimu.co.uk, quoting “Career Opportunity at Tier” or apply directly on Tier’s website.</p>
                                <a href="#" class="btn btn-primary btn-hover-dark">Apply</a>
                            </div>
                            <!-- About Content End -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('assets/images/spotlight-documentaries.jpg'); ?>" alt="About">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <!-- About Content Start -->
                            <div class="about-content">
                                <h2 class="main-title">Science Documentaries</h2>
                                <p>If you are a young person in our community with an interest in science, a company in our network has occasional vacancies 
                                for making documentaries (specialist factual), or conducting research.</p>
                                <p>Email hello@elimu.co.uk to express your interest in being connected with this company.</p>
                            </div>
                            <!-- About Content End -->
