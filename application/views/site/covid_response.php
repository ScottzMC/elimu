...
<head>
    ...
    <title>Covid Response || Elimu </title>
            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: #dda20b;">Covid Response</li>
                    </ul>
                    <h2 class="title">Covid Response <span style="color: #dda20b;">Elimu.</span></h2>
                </div>
                <!-- Page Banner End -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('uploads/covid/'.$cov->image); ?>" alt="Covid Response">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content">
                                <h2 class="main-title"><?php echo $cov->title; ?></h2>
                                <p><b><?php echo $cov->body; ?></b></p>
