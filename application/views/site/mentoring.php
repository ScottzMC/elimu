            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: #dda20b;">Mentoring</li>
                    </ul>
                    <h2 class="title"><?php echo $ment->title; ?> <span style="color: #dda20b;">Elimu.</span></h2>
                </div>
                <!-- Page Banner End -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('uploads/mentoring/'.$ment->image); ?>" alt="Mentoring">
                                </div>
