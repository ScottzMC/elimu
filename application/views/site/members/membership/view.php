...
<head>
    ...
    <?php if(!empty($membership)){ foreach($membership as $mem){} ?>
    <title><?php echo $mem->membership; ?> || Members || Elimu</title>
    <?php }else{ ?>
                ...
                <div class="container-fluid custom-container">
                    ...
                    <div class="admin-courses-tab">
                        ...
                        <div class="courses-tab-wrapper">
                            <form action="<?php echo base_url('members/advanced_search/'.$mem->alias); ?>" method="POST">
                    ...
                    <!-- Admin Courses Tab Start -->
                    <div class="admin-courses-tab">
                        <h3 class="title"><?php echo $mem->membership; ?></h3>
                    </div>
                    <!-- Admin Courses Tab End -->
                            ...
                            <div class="tab-pane fade show active" id="tab1">
                                ...
                                <div class="courses-item">
                                    <div class="item-thumb">
                                        <a href="<?php echo site_url('members/membership_detail/'.$mem->alias.'/'.$mem->id); ?>">
                                            <img height="120" width="120" src="<?php echo base_url('uploads/profile/'.$mem->image); ?>" alt="<?php echo $mem->fullname; ?>">
                                        </a>
                                    </div>

                                    <div class="content-title">
                                        <h3 class="title">
                                            <a href="<?php echo site_url('members/membership_detail/'.$mem->id); ?>">
