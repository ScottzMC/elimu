...
<head>
    ...
    <title>Edit <?php echo $det->title; ?> Opportunity || Elimu</title>
                        ...
                        <div class="col-lg-6" style="margin-left: 30px; padding-bottom: 50px;">
                            ...
                            <!-- Register & Login Form Start -->
                                ...
                                <div class="form-wrapper">
                                    <form action="<?php echo base_url('members/opportunity/edit/'.$det->id); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                                        <div class="single-form">
                                            <label>
                                                <h5>Title</h5>
                                            </label>
                                            <input type="text" name="title" placeholder="Title" value="<?php echo $det->title; ?>">
                                        </div>
                                        <div class="single-form">
                                            <label>
                                                <h5>Description</h5>
                                            </label>
                                            <textarea id="summernote" name="body" rows="5" cols="5" placeholder="Description"><?php echo $det->body; ?></textarea>
                                        </div>
                                        <br>
                                        <div class="single-form">
                                            <label>
                                            ...
                                            <input type="text" name="url" placeholder="Opportunity Link" value="<?php echo $det->url; ?>">
                                        </div>
                                        <div class="single-form">
                                            <button type="submit" name="edit" class="btn btn-primary btn-hover-dark w-100">Save</button>
                                        </div>
                                    </form>
                                </div>
