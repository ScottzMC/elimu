...
<head>
    ...
    <title>Fellowship <?php echo str_replace('-', ' ', $fellow->title); ?> Content || Elimu</title>
                ...
                <div class="courses-video-player">
                    ...
                    <div class="courses-enroll-content">
                        ...
                        <div class="courses-enroll-title">
                            <h2 class="title"><?php echo str_replace('-', ' ', $fellow->title); ?></h2>
                        </div>
                ...
                <div class="courses-video-playlist">
                    ...
                    <div class="video-playlist">
                        <div class="accordion" id="videoPlaylist">
                            ...
                            <?php 
                            $query_fellowship = $this->db->query("SELECT DISTINCT(lesson) FROM course WHERE category = '$fellow->category' ")->result();
                            foreach($query_fellowship as $qry_fellow){ 
                            ?>
                            <div class="accordion-item">
                                <button class="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $qry_fellow->lesson; ?>">
                                    <p>Lesson <?php echo $qry_fellow->lesson; ?></p>
                                    <!--<span class="total-duration">01 hour 15 minutes</span>-->
                                </button>

                                <div id="collapse<?php echo $qry_fellow->lesson; ?>" class="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                    <nav class="vids">
                                        <?php 
