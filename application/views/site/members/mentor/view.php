...
<head>
    ...
    <title>Members Mentors || Elimu</title>
                        ...
                        <div class="admin-courses-tab-content" style="height: 100%; padding-bottom: 300px;">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab1">
                                    ...
                                    <!-- Courses Item Start -->
                                    <?php if(!empty($mentor)){ foreach($mentor as $ment){ ?>
                                    <div class="courses-item">
                                        <div class="item-thumb">
                                            <a href="<?php echo site_url('members/mentor/detail/'.$ment->id); ?>">
                                                <img src="<?php echo base_url('uploads/mentoring/'.$ment->image); ?>" alt="<?php echo $ment->title;  ?>">
                                            </a>
                                        </div>
                                        ...
                                        <div class="content-title">
                                            <h3 class="title">
                                                <a href="<?php echo site_url('members/mentor/detail/'.$ment->id); ?>">
                                                    <?php echo str_replace('-', ' ', $ment->title); ?>
                                                </a>
                                            </h3>
                                        </div>
