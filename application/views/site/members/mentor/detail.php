...
<head>
    ...
    <title><?php echo $det->title; ?> || Mentors || Elimu</title>
            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('members/mentor'); ?>">Mentors</a></li>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="courses-details">
                            ...
                            <div class="courses-details-images">
                                <img src="<?php echo base_url('uploads/mentoring/'.$det->image); ?>" alt="">
                            </div>
