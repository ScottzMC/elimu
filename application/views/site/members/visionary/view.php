...
<head>
    ...
    <title>Members || Visionary || Elimu</title>
                                ...
                                <div class="tab-pane fade show active" id="tab1">
                                    ...
                                    <div class="courses-item">
                                        <div class="item-thumb">
                                            <a href="<?php echo site_url('members/visionary/detail/'.$vision->id); ?>">
                                                <img src="<?php echo base_url('uploads/profile/'.$vision->image); ?>" alt="<?php echo $vision->fullname;  ?>">
                                            </a>
                                        </div>
