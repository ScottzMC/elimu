...
<head>
    ...
    <title>Members || Role Model || Elimu</title>
            ...
            <div class="page-content-wrapper py-0">
                ...
                <div class="main-content-wrapper pb-0">
                    <div class="container-fluid custom-container">
                        ...
                        <div class="admin-courses-tab-content" style="height: 100%; padding-bottom: 300px;">
                                ...
                                <div class="tab-pane fade show active" id="tab1">
                                    ...
                                    <div class="courses-item">
                                        <div class="item-thumb">
                                            <a href="<?php echo site_url('members/role_model/detail/'.$role->id); ?>">
                                                <img src="<?php echo base_url('uploads/profile/'.$role->image); ?>" alt="<?php echo $role->fullname;  ?>">
                                            </a>
                                        </div>
