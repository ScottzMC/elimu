...
<head>
    ...
    <title>Role Models || Members || Elimu</title>
        ...
        <div class="section overflow-hidden position-relative" id="wrapper">
            ...
            <div class="sidebar-wrapper">
                <div class="menu-list">
                    ...
                    <a class="active" href="<?php echo site_url('members/role_model'); ?>">
                    ...
                    <div class="admin-courses-tab-content">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="tab1">
                                ...
                                <!-- Courses Item Start -->
                                <?php if(!empty($role_model)){ foreach($role_model as $role){ ?>
                                <div class="courses-item">
                                    <div class="item-thumb">
                                        <a href="<?php echo site_url('members/role_model_detail/'.$role->id); ?>">
                                            <img height="120" width="120" src="<?php echo base_url('uploads/team/'.$role->image); ?>" alt="<?php echo $vision->fullname; ?>">
                                        </a>
                                    </div>
