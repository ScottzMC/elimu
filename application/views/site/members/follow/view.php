            ...
            <div class="page-content-wrapper py-0">
                ...
                <div class="main-content-wrapper pb-0" style="padding-bottom: 300px;">
                    <div class="container-fluid custom-container">
                        ...
                        <div class="admin-courses-tab-content" style="padding-bottom: 600px;">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab1">
    
                                    <!-- Courses Item Start -->
                                    <?php if(!empty($following)){ foreach($following as $follow){ ?>
                                    <div class="courses-item">
                                        <div class="item-thumb">
                                            <a href="<?php echo site_url('members/following/detail/'.$follow->id); ?>">
                                                <img src="<?php echo base_url('uploads/profile/'.$follow->image); ?>" alt="<?php echo $follow->fullname;  ?>">
                                            </a>
                                        </div>
                                        ...
                                        <div class="content-title">
                                            <h3 class="title">
                                                <a href="<?php echo site_url('members/following/detail/'.$follow->id); ?>">
                                                    <?php echo str_replace('-', ' ', $follow->fullname); ?>
                                                </a>
                                            </h3>
                                        </div>
                                        ...
                                        <div class="content-title">
                                            <h3 class="title">
                                                <a href="<?php echo site_url('members/following/detail/'.$follow->id); ?>">
                                                    <?php echo str_replace('-', ' ', $follow->membership); ?>
                                                </a>
                                            </h3>
                                        </div>
