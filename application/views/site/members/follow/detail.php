...
<head>
    ...
    <title><?php echo $det->fullname; ?> || <?php echo $det->fullname; ?> || Elimu</title>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar-widget widget-information">
                                ...
                                <form action="<?php echo base_url('members/following/unfollow_member/'.$det->follower_id); ?>" method="post">
                                ...
                                <form action="<?php echo base_url('members/following/follow_member/'.$det->follower_id); ?>" method="post">
                                    <input type="hidden" name="slug" value="<?php echo $det->slug; ?>">
                                    <input type="hidden" name="fullname" value="<?php echo $det->fullname; ?>">
                                    <input type="hidden" name="email" value="<?php echo $det->email; ?>">
