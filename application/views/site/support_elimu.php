            ...
            <div class="container">
                ...
                <div class="page-banner-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: #dda20b;">Support Elimu</li>
                    </ul>
                    <h2 class="title">Support <span style="color: #dda20b;">Elimu.</span></h2>
                </div>
                <!-- Page Banner End -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('assets/images/support-donate.jpg'); ?>" alt="Donate">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content">
                                ...
                                <p>Job shortages, socioeconomic inequalities, injustice, mental health challenges and disruption to education have caused an increase in demand for our support.</p>
                                <p>Yet still, 9 out of 10 Black, Asian and global majority led organisations are at risk of closing as a result of the pandemic. 
                                Our smaller grassroots organisations only get short-term funding, so are more vulnerable to the economic impact of the pandemic.</p>
                                <p>By donating to Elimu, you will help us to support more youth with skills development and spaces on our Fellowship programme.</p>
                                <a href="<?php echo site_url('donate'); ?>" class="btn btn-primary btn-hover-dark">Donate</a>
                            </div>
                            <!-- About Content End -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('assets/images/support-community.jpg'); ?>" alt="Join Our Community">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content">
                                ...
                                <p>If you’d like to support our youth as a guest speaker, mentor, workshop facilitator, ambassador or partner, register your interest and we’ll be in touch.</p>
                                <a href="#" class="btn btn-primary btn-hover-dark">Join Elimu</a>
                            </div>
                            <!-- About Content End -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images">
                                    <img src="<?php echo base_url('assets/images/support-share.jpg'); ?>" alt="Share">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <!-- About Content Start -->
                            <div class="about-content">
                                <h2 class="main-title">Share</h2>
                                <p>Members and friends of our community are always welcome to share opportunities which may benefit our youth. 
                                The best way to do this is by emailing hello@elimu.co.uk or messaging us on social media.</p>
                                <p>Likewise,  our opportunities and events reach more youth when you repost them on social media.  
                                Please give us a follow and share anything that may benefit your networks on Instagram, Twitter, Facebook or LinkedIn</p>
                                <a href="#" class="btn btn-primary btn-hover-dark">Join Elimu</a>
                            </div>
                            <!-- About Content End -->
